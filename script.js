document.querySelector('.heart').addEventListener('click', function() {
    ...
    xhr.open('GET', 'Cartita_de_amor.pdf', true);// Asegurate que sea el mismo nombre de tu carta, al nombre escrito en esta linea.
  ...
  var countDownMinutes = 1; // Define el tiempo en horas para la cuenta regresiva
  var countDownDate;
